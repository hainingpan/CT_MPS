# This script is compute the shot-to-shot fluctuation given a specific circuit.
import sys
...
# 'p_ctrl':[.4,.45,.5,.55,.6,.65,.7,.75,.8,.85],
'p_ctrl':[0.4,0.45,0.47,0.49,0.5,0.51,0.53,0.55,0.6,.65,.7,.75,.8,.85],
# 'p_ctrl':[0.1],
...
for fixed_params,vary_params in params_list:
    data_MPS_0_T_DW_dict=generate_params(
        ...
        fn_template='Dephasing_L{L}_pctrl{p_ctrl:.3f}_sC{sC}_sm{sm}_O_T.json',
        fn_dir_template='',
